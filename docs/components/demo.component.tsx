...
export default function Demo() {
  ...
  const [configure, setConfigure] = useState<DemoProps>({
    language: supportedLanguages[0].name,
    theme: supportedTheme[0].name as Theme,
    copy: false,
    copybuttontheme: 'Dark',
  });
      ...
      >
        <section className="w-full flex flex-col gap-1">
          ...
          <p className="text-sm sm:text-base">
            Explore and find the theme you want for the language of your choice.
          </p>
        </section>
            ...
            option={[
              {
                ...
                message: 'This allows you to add a copy button to your code',
              },
              {
                value: 'Disable copy button',
                message: "Remove the copy button when you don't want it.",
              },
            ]}
            handleChange={handleChange}
              ...
              <section className="h-full w-full">
                ...
                >
                  {supportedLanguages.find(
                    (lan) => lan.name === configure.language,
                  )?.code ?? ''}
                </ReactHighlightSyntax>
              </section>
            </Tabs.Tab>
  ...
  return (
    <div>
      ...
      <select
        ...
        onChange={(e) =>
          handleChange(removeSpaces(label) as keyof DemoProps, e.target.value)
        }
      >
    ...
    <div className="grid space-y-3">
      <div className="relative flex items-start">
        ...
        <label htmlFor="select" className="ms-3">
          ...
          <span id="select-description" className="block text-sm text">
            {option[0].message}
          </span>
        </label>
      </div>
